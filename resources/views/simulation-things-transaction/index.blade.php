<x-master>
  ...
  <x-slot name="header_page"><i class="bi bi-people-fill"></i> Simulasi Transaksi Barang</x-slot>
  <x-slot name="header_btn">
    ...
    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#simulationThingsModal">
      <i class="bi bi-plus"></i> Data Transaksi</a>
    </button>
  ...
  <x-slot name="content_page">
    <form id="search-form">
      <div class="input-group mb-3">
        <input type="search" class="form-control" placeholder="Cari..." aria-label="Recipient's username" aria-describedby="button-search" id="search-input">
